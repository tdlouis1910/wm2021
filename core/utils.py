...
def predicted_classes(pred_bbox, classes=read_class_names(cfg.YOLO.CLASSES)):

    out_scores, out_classes, num_boxes = pred_bbox
    num_classes = len(classes)
